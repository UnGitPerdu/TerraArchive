...
using TerraArchive.Items.Weapons.EyeOfHorus;
    ...
    internal class Himari : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Oh, do you need my help?"),
            });
        }
        ...
        public override string GetChat()
        {
            ...
            {
                chat.Add(Language.GetTextValue("Himari_Party", Main.npc[partyGirl].GivenName));
            }
            // These are things that the NPC has a chance of telling you when you talk to it.
            chat.Add(Language.GetTextValue("Himari_1"));
            chat.Add(Language.GetTextValue("Himari_2"));
            chat.Add(Language.GetTextValue("Himari_3"));
            chat.Add(Language.GetTextValue("Himari_4"), 5.0);
            chat.Add(Language.GetTextValue("Himari_5"), 0.1);

            if (NumberOfTimesTalkedTo >= 10)
            {
                //This counter is linked to a single instance of the NPC, so if ExamplePerson is killed, the counter will reset.
                chat.Add(Language.GetTextValue("Himari_10"));
            }
            if (NumberOfTimesTalkedTo == 0)
                chat.Add(Language.GetTextValue("Oh hello Sensei. I wasn't expecting to find you here. How did I got here?\r\nWell, as the genius beeautiful hacker that I am,\r\nI though it would be interesting to hack in the newest GDD creation"));
