...
using TerraArchive.NPCs.School.Gehenna.Problem_Solver_68.Player.Kayoko;
...
namespace TerraArchive.NPCs.School.Gehenna.Problem_Solver_68.Player.Kayoko
{
	...
	public class Player_KayokoHead : ModItem
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<Player_KayokoBody>() && legs.type == ModContent.ItemType<Player_KayokoLegging>();
