...
namespace TerraArchive.NPCs.School.Gehenna.Problem_Solver_68.Player.Mutsugi
{
	...
	public class Player_MutsugiHead : ModItem
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<Player_MutsugiBody>() && legs.type == ModContent.ItemType<Player_MutsugiLegging>();
